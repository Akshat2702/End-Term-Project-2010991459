...
function Register() {
    ...
    const submit = (e) => {
        ...
        if (data.get("pass") != data.get("re_pass")) {
            toast.error("Confirm Password & Your Password do not match!");
            return;
        }
            ...
            <div className="containersss">
                <div className="signup-content">
                        ...
                        <form onSubmit={submit} className="register-form" id="register-form">
                            ...
                            <div className="form-group">
                                ...
                                <select style={{ width: "100%", padding: "5px 10px", marginTop: "10px" }} name="type">
                                    ...
                                    <option value="buyer">Buy/Rent</option>
                                </select>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <label htmlFor="agree-term" className="label-agree-term"><span><span></span></span>I agree with all Statements in  <a href="#" className="term-service">Terms Of Service</a></label>
                            </div>
                    ...
                    <div className="signup-image">
                        ...
                        <Link to="/login" className="signup-image-link">Already have an Account? Click Here to Log In!</Link>
                    </div>
                </div>
            </div>
        </section>
